...
<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title">
            <a class="btn bg-dark btn-sm" href="/preventives/new" onclick="createCorrelativo(event,'pr')">New Preventive</a>
        </h3>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="adminsTable" class="table table-bordered table-striped tablePreventives">
            <thead>
                <tr>
                    <th>Código</th>
                    <th>Asesor</th>
