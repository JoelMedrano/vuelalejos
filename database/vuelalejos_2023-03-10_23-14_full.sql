...
insert  into `correlatives`(`id_correlative`,`code_correlative`,`name_correlative`,`initial_correlative`,`actual_correlative`,`final_correlative`) values (1,'cl','clients',1,7,NULL),(2,'pr','preventives',1,20,NULL);
